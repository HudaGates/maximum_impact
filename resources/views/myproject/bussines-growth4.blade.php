...
<div class="growth-container">
    <form method="POST" action="{{ route('bussines-growth5') }}">
        @csrf
        ...
        <div style="position: relative;">
            ...
            <textarea name="team_dev_target_month_1" required></textarea>
            <img src="/images/logo-m.png" class="logo-m" alt="Logo M">
        </div>
        <div class="btn-container">
            <a href="{{ route('bussines-growth3-page') }}" class="btn text-decoration-none">Back</a>
