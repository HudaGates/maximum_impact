...
<body>
    <div class="left">
        ...
        <p class="desc">
            How will you grow your impact through investment? Share your <strong>Strategy.</strong>.
            We’ll turn your ideas into <strong>actionable steps</strong>—no pressure, just progress!
            <br><em>(or skip if you're still planning)</em>
        </p>

        <form method="POST" action="{{ route(name: 'step8-invest.submit') }}">
            @csrf
            ...
            <div class="buttons">
                <a href="{{ route('step-invest.step7-invest') }}" style="text-decoration: none" class="btn btn-prev">← Previous</a>
